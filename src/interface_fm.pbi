...
Enumeration FormGadget
  ...
  #check_export_character_name
  #check_export_counter_name
...
Procedure OpenWindow_0(x = 0, y = 0, width = 800, height = 750)
  ...
  FrameGadget(#frame_background_color, 10, 10, 480, 60, "background color and font size information")
  CanvasGadget(#view_background_color, 150, 27, 50, 35, #PB_Canvas_Border)
  ButtonGadget(#button_background_color_select, 20, 35, 120, 20, "Background Color")
  TextGadget(#label_font_size_view, 250, 40, 200, 20, "")
  CanvasGadget(#canvas_character_view, 10, 80, 480, 640, #PB_Canvas_Border | #PB_Canvas_ClipMouse | #PB_Canvas_Keyboard)
  PanelGadget(#panel_font, 510, 10, 290, 220)
  ...
  TextGadget(#label_font_size, 90, 73, 190, 20, "Font Size")
  CheckBoxGadget(#check_bold, 30, 115, 50, 20, "Bold")
  CheckBoxGadget(#check_italic, 90, 115, 60, 20, "Italic")
  CheckBoxGadget(#check_underline, 160, 115, 70, 20, "underline")
  SpinGadget(#spin_offset_x, 40, 155, 50, 25, -999, 999, #PB_Spin_Numeric)
  TextGadget(#label_font_offset, 100, 159, 90, 20, "X <- Offset -> Y", #PB_Text_Center)
  SpinGadget(#spin_offset_y, 205, 155, 50, 25, -999, 999, #PB_Spin_Numeric)
  AddGadgetItem(#panel_font, -1, "Color")
  OptionGadget(#option_gradient_linear, 10, 5, 60, 20, "Linear")
  SetGadgetState(#option_gradient_linear, 1)
  OptionGadget(#option_gradient_circular, 80, 5, 70, 20, "Circular")
  SpinGadget(#spin_scale_linear_gradient, 170, 5, 50, 20, -50, 100, #PB_Spin_Numeric)
  TextGadget(#label_scale_linear_gradient, 230, 8, 50, 20, "Scale")
  SpinGadget(#spin_radius_circular_gradient, 170, 5, 50, 20, 1, 500, #PB_Spin_Numeric)
  HideGadget(#spin_radius_circular_gradient, 1)
  TextGadget(#label_radius_circular_gradient, 230, 8, 50, 20, "Radius")
  HideGadget(#label_radius_circular_gradient, 1)
  ;CanvasGadget(#gradient_color, 10, 30, 270, 70)
  gradient::new(#Window_0, #gradient_color, 10, 30, 270, 70)
  SpinGadget(#spin_posx_color_linear_gradient, 10, 110, 50, 20, -999, 999, #PB_Spin_Numeric)
  TextGadget(#label_position_color_gradient, 65, 113, 165, 20, "X <- Gradient position -> Y", #PB_Text_Center)
  SpinGadget(#spin_posy_color_linear_gradient, 230, 110, 50, 20, -999, 999, #PB_Spin_Numeric)
  SpinGadget(#spin_posx_color_circular_gradient, 10, 110, 50, 20, -999, 999, #PB_Spin_Numeric)
  HideGadget(#spin_posx_color_circular_gradient, 1)
  SpinGadget(#spin_posy_color_circular_gradient, 230, 110, 50, 20, -999, 999, #PB_Spin_Numeric)
  HideGadget(#spin_posy_color_circular_gradient, 1)
  TextGadget(#label_angle_color, 10, 140, 50, 20, "Angle")
  StringGadget(#entry_angle_color, 65, 138, 35, 20, "0", #PB_String_Numeric)
  TrackBarGadget(#track_angle_color, 110, 140, 160, 20, 0, 359)
  TextGadget(#label_alpha_color, 10, 172, 50, 20, "Alpha")
  StringGadget(#entry_alpha_color, 65, 170, 35, 20, "255", #PB_String_Numeric)
  TrackBarGadget(#track_alpha_color, 110, 172, 160, 20, 0, 255)
  ...
  SpinGadget(#spin_size_outline, 220, 5, 60, 20, 1, 500, #PB_Spin_Numeric)
  ;CanvasGadget(#gradient_outline, 10, 30, 270, 50)
  gradient::new(#Window_0, #gradient_outline,10,30,270,50)
  OptionGadget(#option_linear_gradient_outline, 10, 85, 55, 20, "Linear")
  SetGadgetState(#option_linear_gradient_outline, 1)
  OptionGadget(#option_circular_gradient_outline, 70, 85, 65, 20, "Circular")
  SpinGadget(#spin_scale_gradient_outline, 170, 85, 50, 20, -50, 100, #PB_Spin_Numeric)
  TextGadget(#label_scale_gradient_outline, 230, 88, 50, 20, "Scale")
  SpinGadget(#spin_radius_gradient_outline, 170, 85, 50, 20, 1, 500, #PB_Spin_Numeric)
  HideGadget(#spin_radius_gradient_outline, 1)
  TextGadget(#label_radius_gradient_outline, 230, 88, 50, 20, "Radius")
  HideGadget(#label_radius_gradient_outline, 1)
  SpinGadget(#spin_offset_x_outline, 10, 110, 50, 20, -999, 999, #PB_Spin_Numeric)
  TextGadget(#label_offset_outline, 65, 113, 165, 20, "X <- offset Outline -> Y", #PB_Text_Center)
  SpinGadget(#spin_offset_y_outline, 230, 110, 50, 20, -999, 999, #PB_Spin_Numeric)
  TextGadget(#label_angle_outline, 10, 140, 50, 20, "Angle")
  StringGadget(#entry_angle_outline, 65, 138, 35, 20, "0", #PB_String_Numeric)
  TrackBarGadget(#track_angle_outline, 110, 140, 160, 20, 0, 359)
  SpinGadget(#spin_posx_circular_gradient_outline, 10, 140, 50, 20, -999, 999, #PB_Spin_Numeric)
  HideGadget(#spin_posx_circular_gradient_outline, 1)
  TextGadget(#label_position_gradient_outline, 70, 145, 150, 20, "X <- Gradient position -> Y", #PB_Text_Center)
  HideGadget(#label_position_gradient_outline, 1)
  SpinGadget(#spin_posy_circular_gradient_outline, 230, 140, 50, 20, -999, 999, #PB_Spin_Numeric)
  HideGadget(#spin_posy_circular_gradient_outline, 1)
  TextGadget(#label_alpha_outline, 10, 172, 50, 20, "Alpha")
  StringGadget(#entry_alpha_outline, 65, 170, 35, 20, "255", #PB_String_Numeric)
  TrackBarGadget(#track_alpha_outline, 110, 172, 160, 20, 0, 255)
  AddGadgetItem(#panel_font, -1, "Effect")
  CloseGadgetList()
  PanelGadget(#panel_export, 510, 250, 290, 470)
  ...
  ComboBoxGadget(#combo_image_output, 20, 78, 100, 30)
  AddGadgetItem(#combo_image_output, -1, "PNG", 0, 1)
  AddGadgetItem(#combo_image_output, -1, "JPEG")
  AddGadgetItem(#combo_image_output, -1, "BMP")
  ...
  CheckBoxGadget(#check_export_character_name, 40, 198, 230, 30, "Character in name (FileA,FileB...)")
  CheckBoxGadget(#check_export_counter_name, 40, 228, 230, 30, "Add counter (File1, File2,...)")
  ...
  StringGadget(#entry_format_data, 20, 170, 250, 25, "%asc:%x:%y:%sizex:%sizey")
  TextGadget(#label_info_format_data_001, 20, 200, 250, 20, "EX :  name_%i,%x,%y,%sizex,%sizey")
  ...
  StringGadget(#entry_file_name_text, 20, 408, 250, 25, "%image subimages.txt")
  CloseGadgetList()
EndProcedure
...
Procedure initialisation_interface() 
  ...
  SetGadgetState(#combo_image_output,0)
  SetGadgetState(#option_image_export_single, 1)
